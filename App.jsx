export const rundown = [
  ...
  { time: "08.25 - 08.35", event: "Doa Pembuka oleh Bapak Wiyarso" },
  ...
  { time: "09.25 - 09.45", event: "Pemutaran Video Angkatan (pada saat penyerahan berlangsung, video diputar dengan volume rendah; setelah penyerahan selesai, volume dinaikkan)" },
  { time: "09.45 - 09.55", event: "Persembahan dari Guru Kesiswaan" },
  { time: "09.55 - 10.05", event: "Pengumuman Siswa Terbaik Paralel per Jurusan" },
