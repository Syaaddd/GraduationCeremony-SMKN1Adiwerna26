...
export default function App() {
  ...
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(160deg, #e0f0ff 0%, #f5faff 30%, #dbeafe 70%, #eff6ff 100%)",
    ...
    >
      ...
      {sparkles.map((s, i) => (
        <span
          key={i}
          className="absolute text-blue-200 animate-sparkle select-none pointer-events-none"
          style={s}
        >
          ✦
        </span>
      ...
      <header className="relative text-center pt-16 pb-8 px-4">
        ...
        <p className="text-blue-400 text-[10px] tracking-widest uppercase font-medium mb-1">
        ...
        <h2
          className="text-4xl text-blue-500 -mt-1"
      ...
      <main className="px-4 max-w-lg mx-auto space-y-5 pb-28">
        ...
        <div className="bg-white/60 backdrop-blur-md rounded-3xl p-5 shadow-sm border border-blue-100 grid grid-cols-3 gap-4 text-center">
          {[
            ...
            <div key={i}>
              ...
              <p className="text-blue-800 font-bold text-xs leading-tight">
                {c.main}
              </p>
        ...
        {/* Countdown */}
        <div>
          <p className="text-center text-blue-400 text-[10px] tracking-widest uppercase mb-3 font-medium">
            Hitung Mundur
          </p>
          <CountdownTimer />
        </div>
        ...
        {/* Tab content */}
        {activeTab === "undangan" && <TabUndangan />}
        {activeTab === "rundown"  && <TabRundown />}
        {activeTab === "rsvp"     && <TabRSVP />}
      </main>
